...
export default function Restaurateurs() {
  ...
  const filteredRestaurateurs = restaurateurs.filter(resto => {
    ...
    const matchesStatus = selectedStatus === "tous" || resto.statut === selectedStatus;
  ...
  const stats = {
    ...
    chiffreTotal: restaurateurs.reduce((total, r) => total + r.chiffreAffaires, 0)
  };
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-4xl font-black text-gray-900">Gestion des Restaurateurs</h1>
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-orange-600 font-medium">{resto.id}</p>
                          <p className="text-gray-600">Propriétaire: {resto.proprietaire}</p>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-600">{resto.email}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Phone className="w-4 h-4 text-emerald-500" />
                        <span className="text-sm text-gray-600">{resto.telephone}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <MapPin className="w-4 h-4 text-purple-500" />
                        <span className="text-sm text-gray-600">{resto.adresse}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Calendar className="w-4 h-4 text-orange-500" />
                        <span className="text-sm text-gray-600">
                          {new Date(resto.dateInscription).toLocaleDateString('fr-FR')}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                      <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
                        <div className="flex items-center justify-center space-x-1 mb-2">
                          ...
                          <span className="text-xl font-black text-gray-900">{resto.note}</span>
                        </div>
                        <div className="text-xs text-gray-500">Note moyenne</div>
                      </div>
                      <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
                        <div className="text-xl font-black text-blue-600">{resto.totalPlats}</div>
                        <div className="text-xs text-gray-500">Plats</div>
                      </div>
                      <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
                        <div className="text-xl font-black text-emerald-600">{resto.commandesLivrees}</div>
                        <div className="text-xs text-gray-500">Commandes</div>
                      </div>
                      <div className="bg-white rounded-xl p-4 border border-gray-200 text-center">
                        <div className="text-xl font-black text-orange-600">${resto.chiffreAffaires.toLocaleString()}</div>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                      <div className="text-sm text-gray-600">
                        ...
                        <span className="text-orange-600 font-bold">{resto.typeComission}</span>
                      </div>
