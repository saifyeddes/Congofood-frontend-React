  ...
  const restaurants = [
    {
      ...
      description:
        "Restaurant traditionnel congolais dans un cadre authentique et chaleureux.",
    },
    {
      id: 2,
      ...
      description:
        "Restaurant élégant avec terrasse panoramique et cuisine fusion créative.",
    },
    {
      id: 3,
      ...
      description:
        "Restaurant convivial proposant un voyage culinaire à travers l'Afrique.",
    },
  ];
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            <div className="bg-gray-50 rounded-lg p-2 text-center">
              ...
              <div className="text-gray-600">
                {restaurant.tables.small.available} disponibles
              </div>
            </div>
            <div className="bg-gray-50 rounded-lg p-2 text-center">
              <div className="font-semibold text-blue-600">Tables 4-6p</div>
              <div className="text-gray-600">
                {restaurant.tables.medium.available} disponibles
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-blue-600 text-white py-16">
            <div className="container mx-auto px-6 text-center">
              ...
              <p className="text-xl text-emerald-100 mb-8">
                Réservez en quelques clics dans les meilleurs restaurants de
                Kinshasa
              </p>
              ...
              <div className="lg:col-span-2">
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">
                    Sélectionnez le restaurant où vous souhaitez réserver une
                    table
                  </p>
                </div>
                    ...
                    {!selectedRestaurant ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-sm text-gray-500">
                          Choisissez d'abord un restaurant pour continuer votre
                          réservation
                        </p>
                      </div>
                    ) : (
                              ...
                              <DialogDescription className="space-y-4 pt-4">
                                ...
                                <div className="text-center">
                                  <p className="text-sm text-gray-600 mb-4">
                                    Un SMS de confirmation vous sera envoyé au{" "}
                                    {reservationData.phone}
                                  </p>
                                  <Button
